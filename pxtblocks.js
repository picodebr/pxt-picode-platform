...
(function (pxtblockly) {
    ...
    var FieldTilemap = /** @class */ (function (_super) {
        ...
        FieldTilemap.prototype.showEditor_ = function () {
            ...
            var allTiles = project.getProjectTiles(this.state.tileset.tileWidth);
        ...
        FieldTilemap.prototype.parseBitmap = function (newText) {
            if (!this.blocksInfo)
                return;
            var tilemap = pxt.sprite.decodeTilemap(newText, "typescript", pxt.react.getTilemapProject()) || emptyTilemap(this.params.initWidth, this.params.initHeight);
            // Ignore invalid bitmaps
    ...
    function checkLegacyTilemap(tilemap, galleryItems) {
        if (!tilemap || !tilemap.tilemap || !tilemap.tilemap.width || !tilemap.tilemap.height)
            return false;
        if (!tilemap.layers || tilemap.layers.width !== tilemap.tilemap.width || tilemap.layers.height !== tilemap.tilemap.height)
            return false;
    ...
    function emptyTilemap(width, height) {
        return new pxt.sprite.TilemapData(new pxt.sprite.Tilemap(width, height), { tileWidth: 16, tiles: [] }, new pxt.sprite.Bitmap(width, height).data());
    }
})(pxtblockly || (pxtblockly = {}));
/// <reference path="../../built/pxtlib.d.ts" />
var pxtblockly;
