                    ...
                    if (si_1) {
                        ...
                        if (existing) {
                            ...
                            if (existing.kind == 9 /* Interface */ && si_1.kind != 9 /* Interface */) {
                                ...
                                var foundSrc = (_a = existing.attributes._source) === null || _a === void 0 ? void 0 : _a.trim();
        ...
        (function (service_1) {
            ...
            var operations = {
                ...
                syntaxInfo: function (v) {
                    ...
                    if (isPython) {
                        ...
                        if (isSymbolReq || isSignatureReq) {
                            var tsNode = findInnerMostNodeAtPosition(tsAst, v.position);
                            if (tsNode) {
                                if (isSymbolReq) {
                                    var symbol = tc.getSymbolAtLocation(tsNode);
                                    if (symbol) {
                                        var pxtSym = getPxtSymbolFromTsSymbol(symbol, opts.apisInfo, tc);
                                    ...
                                    if (pxtCall) {
                                        ...
                                        opts.syntaxInfo.beginPos = tsNode.getStart();
                                        opts.syntaxInfo.endPos = tsNode.getEnd();
                                        var tsCall = getParentCallExpression(tsNode);
                                        if (tsCall) {
                                            var argIdx = findCurrentCallArgIdx(tsCall, tsNode, v.position);
                    ...
                    if (isSymbolReq && !((_c = opts.syntaxInfo.symbols) === null || _c === void 0 ? void 0 : _c.length)) {
                        var possibleKeyword = getWordAtPosition(v.fileContent, v.position);
                        if (possibleKeyword) {
                ...
                getCompletions: function (v) {
                    ...
                    var tc = prog.getTypeChecker();
                    var tsNode = findInnerMostNodeAtPosition(tsAst, tsPos);
                    ...
                    var call = getParentCallExpression(tsNode);
                    if (call) {
                        // which argument are we ?
                        var paramIdx = findCurrentCallArgIdx(call, tsNode, tsPos);
                        ...
                        if (paramIdx >= 0) {
                            ...
                            if (callSym) {
                                ...
                                if (paramType) {
                                    ...
                                    var matchingApis = getApisForTsType(paramType, call, tc, resultSymbols);
                    ...
                    function patchSymbolWithSnippet(si) {
                        ...
                        if (ts_2.isFunctionLike(n)) {
                            ...
                            if (si.snippetAddsDefinitions
                                ...
                                || (!isPython && !si.snippet)) {
                                var snippetNode = getSnippet(lastApiInfo.apis, takenNames, v.runtime, si, n, isPython);
                                var snippet = snippetStringify(snippetNode);
                                var snippetWithMarkers = snippetStringify(snippetNode, true);
                                var addsDefinitions = snippetAddsDefinitions(snippetNode);
                                if (isPython) {
                ...
                snippet: function (v) {
                    ...
                    var snippetNode = ts.pxtc.service.getSnippet(lastApiInfo.apis, takenNames, v.runtime, fn, n, isPython);
                    var snippet = snippetStringify(snippetNode);
                    return snippet;
                },
            ...
            function getCallSymbol(callExp) {
                ...
                var api = lastApiInfo.apis.byQName[qName];
                return api;
            }
            ...
            service_1.snippetStringify = snippetStringify;
            ...
            service_1.snippetHasReplacementPoints = snippetHasReplacementPoints;
            ...
            service_1.snippetAddsDefinitions = snippetAddsDefinitions;
                ...
                function getParameterDefault(param) {
                    ...
                    if (attrs && attrs.paramDefl && attrs.paramDefl[name]) {
                        if (typeNode.kind == pxtc.SK.AnyKeyword) {
                            ...
                            if (!Number.isNaN(+defaultName)) {
                                ...
                                typeNode.kind = pxtc.SK.NumberKeyword;
                            }
                            else if (defaultName == "FALSE" || defaultName == "TRUE") {
                                // try to parse as a bool
                                typeNode.kind = pxtc.SK.BooleanKeyword;
                            }
                            else if (defaultName.includes(".")) {
                                // try to parse as an enum
                                typeNode.kind = pxtc.SK.EnumKeyword;
                            }
                            else {
                                // otherwise it'll be a string
                                typeNode.kind = pxtc.SK.StringKeyword;
                            }
                        }
                        if (typeNode.kind == pxtc.SK.StringKeyword) {
                            var defaultName = attrs.paramDefl[name];
                            var snippet_1 = typeNode.kind == pxtc.SK.StringKeyword && defaultName.indexOf("\"") != 0 ? "\"" + defaultName + "\"" : defaultName;
                            return snippet_1;
                        }
                        return attrs.paramDefl[name];
                    }
                    function getDefaultValueOfType(type) {
                        ...
                        if (type.symbol && type.symbol.flags & ts_2.SymbolFlags.Enum) {
                            var defl = getDefaultEnumValue(type, python);
                            return defl;
                        }
                    ...
                    function snippetFromSpriteEditorParams(opts) {
                        ...
                        if ((_a = opts) === null || _a === void 0 ? void 0 : _a.sizes) {
                            ...
                            for (var i = 0; i < pairs.length; i++) {
                                ...
                                var screenSize = (_b = runtimeOps) === null || _b === void 0 ? void 0 : _b.screenSize;
                        ...
                        parsed.initColor = withDefault((_c = opts) === null || _c === void 0 ? void 0 : _c.initColor, parsed.initColor);
                        parsed.initWidth = withDefault((_d = opts) === null || _d === void 0 ? void 0 : _d.initWidth, parsed.initWidth);
                        parsed.initHeight = withDefault((_e = opts) === null || _e === void 0 ? void 0 : _e.initHeight, parsed.initHeight);
                    ...
                    function getDefaultValueFromFieldEditor(paramName) {
                        ...
                        var blockParam = (_a = compileInfo.parameters) === null || _a === void 0 ? void 0 : _a.find(function (p) { return p.actualName === name; });
                    ...
                    if (shadowSymbol) {
                        ...
                        if (recursionDepth < 3 && lastApiInfo.decls[shadowSymbol.qName]) {
                            var snippet_2 = getSnippet(apis, takenNames, runtimeOps, shadowSymbol, lastApiInfo.decls[shadowSymbol.qName], python, recursionDepth + 1);
                            if (snippet_2)
                                return snippet_2;
                        }
                    }
                    ...
                    var basicRes = getBasicKindDefault(typeNode.kind, python);
